...
export const en: Dictionary = {
  ...
  repair: {
    ...
    physicalFlags: 'Physical marks',
    trackHint: 'Scan to track your device status',
  ...
  invoice: {
    ...
    notes: 'Notes',
    qrHint: 'Scan the code to verify this invoice',
  ...
  pdf: {
    ...
    failed: 'Could not generate the file',
    signature: 'Signature',
    ...
    page: 'Page',
    of: 'of',
    attachedInvoice: 'Attached: invoice copy',
    attachedReceipt: 'Attached: device intake receipt',
    attachedQuotation: 'Attached: quotation',
    sendWithPdf: 'Send with PDF attachment',
  },
